...
class SerLCD {
  ...
  setBacklight(r, g, b) {
    ...
    g = 158 + map(g, 0, 255, 0, 29);
    b = 188 + map(b, 0, 255, 0, 29);
  ...
  setFastBacklight(r, g, b) {
    ...
    this.command(SET_RGB_COMMAND, r, g, b);
    sleep(10);  // same as original library.
  }
...
// Source: https://reference.arduino.cc/reference/en/language/functions/math/map/
